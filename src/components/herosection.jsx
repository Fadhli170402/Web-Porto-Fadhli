    ...
    return(
        ...
        <div className="container mx-auto px-10 flex flex-col md:flex-row items-center justify-between">
          <div className="md:w-1/2 mb-10 md:mb-0">
            ...
            >
            <img src="/linkedin.png" alt="LinkedIn" className="w-12 h-12 relative z-10" />
            </a>
            <a 
                ...
                className='hover:text-indigo-400 transition'
            >
            <img src="/instagram.png" alt="Instagram" className="w-12 h-12 relative z-10" />
            </a>
            <a 
                ...
                className='hover:text-indigo-400 transition'
            >
            <img src="/github.png" alt="GitHub" className="w-12 h-12 relative z-10" />
            </a>
